...
function __subcompact_bidi_BFS({ map, frtr, vstd, other_vstd, markFrontier, markVisited, startIteration }) {
    if (frtr.isEmpty())
        return null;
    ...
    for (let i = 0; i < 4; i++) {
        ...
        if (vstd[ptt_visit[0]][ptt_visit[1]] || map[ptt_visit[0]][ptt_visit[1]] || frtr.exists(ptt_visit, compare_tile))
